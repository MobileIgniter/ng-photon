  ...
  var ngPhotonDec = [
    ...
    function ($q, $http) {
        ...
        $http.get(baseURL + 'scan-ap')
          .then(function (resp) {
            ...
            angular.forEach(networkList, function (ap) {
              ...
              switch (ap.sec) {
                case 1:
                  ap.networkType = "WEP_PSK";
                  break;
                case 0x8001:
                  ap.networkType = "WEP_SHARED";
                  break;
                case 0x00200002:
                  ap.networkType = "WPA_TKIP_PSK";
                  break;
                case 0x00200004:
                  ap.networkType = "WPA2_AES_PSK";
                  break;
                case 0x00400004:
                  ap.networkType = "WPA2_TKIP_PSK";
                  break;
                case 0x00400002:
                  ap.networkType = "WPA2_TKIP_PSK";
                  break;
      ...
      ngPhoton.configure = function (obj) { ///obj.accessPoint, obj.password)
        ...
        if (!obj.password) {
          obj.password = ''; /// so it rsa.encrypt doesn't crash
        }
        config = {
